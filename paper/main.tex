...
reduction) and the discriminating signal is \bestSignal\,\bestSignalUnits{} in
\bestSignalObservable, or \bestSignalToNoise{} measurement standard deviations (exceeds
noise: \bestExceedsNoise). \nPairsSeparated{} of \nPairsTested{} examined pairs produce a
signal above one measurement error, and \nPairsNarrowed{} show a meaningful narrowing of the
invisible direction. The maneuver was interpretable in \bestManeuverUsable\% of the patients
it was applied to; any remainder are ventricles too stiff to fill at the provoked heart
rate, which is not a numerical failure but the maneuver being uninterpretable in exactly the
patients it was proposed for.
